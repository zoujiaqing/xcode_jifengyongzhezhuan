...
extern "C"
{
    ...
    void stopEffectbyPathJNI(const char* path)
    {
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, "stopEffect", "(Ljava/lang/String;)V"))
        {
            return ;
        }
    ...
    void pauseEffectbyPathJNI(const char* path)
    {
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, "pauseEffect", "(Ljava/lang/String;)V"))
        {
            return ;
        }
    ...
    void resumeEffectbyPathJNI(const char * path)
    {
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, "resumeEffect", "(Ljava/lang/String;)V"))
        {
            return ;
        }
