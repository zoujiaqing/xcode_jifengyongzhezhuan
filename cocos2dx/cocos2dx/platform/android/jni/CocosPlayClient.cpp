...
typedef std::map<std::string, bool> CocosPlayClientFileCacheMap;
typedef std::pair<std::string, bool> CocosPlayClientFileCachePair;

static CocosPlayClientFileCacheMap __fileExistsCaches;
...
static bool isNotifyFileLoadedEnabled()
{
    lazyInit();
    return __isNotifyFileLoadedEnabled;
}
...
bool fileExists(const std::string& filePath)
{
    ...
    CocosPlayClientFileCacheMap::iterator iter = __fileExistsCaches.find(filePath);
    ...
    if (__fileExistsCaches.find(filePath) == __fileExistsCaches.end())
    {
        __fileExistsCaches.insert(CocosPlayClientFileCachePair(filePath, ret));
    }
