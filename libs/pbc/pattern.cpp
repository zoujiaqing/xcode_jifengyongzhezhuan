...
pbc_pattern_unpack(struct pbc_pattern *pat, struct pbc_slice *s, void * output) {
	...
	bool *field = (bool *)_pbcM_malloc(sizeof(bool) * pat->count);
...
_comp_field(const void * a, const void * b) {
	const struct _pattern_field * fa =(const _pattern_field *) a;
	const struct _pattern_field * fb = (const _pattern_field *)b;
